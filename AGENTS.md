...
This project is indexed by GitNexus as **claude-code-delegate** (684 symbols, 985 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
